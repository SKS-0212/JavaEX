...
class Employee{
    ...
    private final Date joiningDate = new Date();
    ...
    void display(List<Employee> list){
        ...
        for (Employee e : list) {
            System.out.println(e.getEmoNo() + "\t\t" + e.getEmpName() + "\t\t" + e.getDepartment() + "\t\t" + e.getDesignation(e.designationCode) + "\t\t" + e.calculateSalary(e.designationCode));
        }
        System.out.println();
    }
    ...
    void  getEmployeeById(int empId,List<Employee> list){
        ...
        for (Employee e : list) {
            if (empId == e.emoNo) {
                System.out.println(e.getEmoNo() + "\t\t" + e.getEmpName() + "\t\t" + e.getDepartment() + "\t\t" + e.getDesignationCode() + "\t\t" + e.calculateSalary(e.designationCode));
            }
        }
        System.out.println();
